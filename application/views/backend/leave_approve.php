...
<div class="page-wrapper">
    ...
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h3 class="text-themecolor"><i class="fa fa-clone" style="color:#1976d2"> </i>Đơn</h3>
        </div>
        ...
        <div class="row m-b-10">
            <?php // if($this->session->userdata('user_type')=='EMPLOYEE'){ ?> 
                <div class="col-12">
                    ...
                    <button type="button" class="btn btn-primary"><i class="fa fa-bars"></i><a href="<?php echo base_url(); ?>leave/Holidays" class="text-white"><i class="" aria-hidden="true"></i> Danh sách kỳ nghỉ</a></button>
                </div>                       
            <?php // } ?> 
        </div> 
        <div class="row">
                                    ...
                                    <tr style="vertical-align:top">
                                        ...
                                        <td class="jsgrid-align-center">
                                           ...
                                           <?php if($value->leave_status =='Approve'){ ?>
                                            ...
                                            <a href="" title="Sửa" class="btn btn-sm btn-success waves-effect waves-light Status" data-employeeId=<?php echo $value->em_id; ?>  data-id="<?php echo $value->id; ?>" data-value="Approve" data-duration="<?php echo $value->leave_duration; ?>" data-type="<?php echo $value->typeid; ?>">Chấp Nhận</a>       
                                            <a href="" title="Sửa" class="btn btn-sm btn-danger waves-effect waves-light  Status" data-id = "<?php echo $value->id; ?>" data-value="Rejected" >Từ Chối</a>
                                            <br> 

                                            <?php } elseif($value->leave_status =='Rejected'){ ?>
                                            <?php } ?>
                                            <a href="" title="Sửa" class="btn btn-sm btn-primary waves-effect waves-light leaveapp" data-id="<?php echo $value->id; ?>" ><i class="fa fa-pencil-square-o"></i></a>
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="span pull-right">
                                        <button class="btn btn-info fetchLeaveTotal">Tổng Đã Nhận</button>
                                    </div>
                                    <br>
                                </div>
                                <div class="form-group">
                                    ...
                                    <label for="radio_1">Hàng giờ</label>
