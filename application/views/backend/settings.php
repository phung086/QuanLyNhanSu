                            ...
                            <div class="card-body">
                                <div class="table_body">
                                    <form action="Add_Settings" id="fileUploadForm"  method="post" enctype="multipart/form-data" accept-charset="utf-8">
                                        ...
                                        <div class="form-group clearfix">
                                            <label for="title" class="col-md-3">Tên Web</label>
                                            <div class="col-md-9">
                                        ...
                                        <div class="form-group clearfix">
                                            <label for="description" class="col-md-3">Vị Trí</label>
                                            <div class="col-md-9">
                                        ...
                                        <div class="form-group clearfix">
                                            <div class="col-md-9 col-md-offset-3">
                                                ...
                                                <button type="submit" name="submit" id="btnSubmit" class="btn btn-success">Xác Nhận</button>
