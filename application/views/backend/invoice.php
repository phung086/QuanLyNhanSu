         ...
         <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor"><i class="fa fa-university" aria-hidden="true"></i> Hoá Đơn</h3>
                </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                        <li class="breadcrumb-item active"><i class="fa fa-university" aria-hidden="true"></i> Hoá Đơn</li>
                    </ol>
                </div>
            </div>
            <style type="text/css">
...
<!--                        <button type="button" class="btn btn-info"><i class="fa fa-plus"></i><a data-toggle="modal" data-target="#TypeModal" data-whatever="@getbootstrap" class="text-white TypeModal"><i class="" aria-hidden="true"></i> Add Payroll </a></button>-->
                        <button type="button" class="btn btn-primary"><i class="fa fa-bars"></i><a href="<?php echo base_url(); ?>Payroll/Salary_List" class="text-white"><i class="" aria-hidden="true"></i>  Trở Lại</a></button>
                        ...
                        <div class="card card-body">
                            <div class="row">
                                <div class="col-md-4 col-xs-6 col-sm-6">
                                    <img src="<?php echo base_url();?>assets/images/fsi.png" style=" width:180px; margin-right: 10px;" />
                                </div>
                                <div class="col-md-8 col-xs-6 col-sm-6 text-left payslip_address">
                                    ...
                                    <p>
                                        Điện Thoại: <?php echo $settingsvalue->contact; ?>, Email: <?php echo $settingsvalue->system_email; ?>
                                    </p>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12 text-left">
                                    <h5 style="margin-top: 15px;">Phiếu lương trong kỳ <?php echo $salary_info->month.' '.$salary_info->year ?></h5>
                                </div>
                            </div>
                            <div class="row" style="margin-bottom: 5px;">
                                <div class="col-md-12"><!-- 
                                    ...
                                    <table class="table table-condensed borderless payslip_info">
                                        ...
                                        <tr>
                                            <td>Ngày trả tiền</td>
                                            <td>: <?php echo date('d-m-Y',strtotime($salary_info->paid_date)); ?></td>
                                            <td>Ngày tham gia</td>
                                ...
                                <div class="col-md-12">
                                    <table class="table table-condensed borderless" style="border-left: 1px solid #ececec;">
                                        ...
                                        <tbody style="border: 1px solid #ececec;">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-right"><?php if(!empty($salary_info->loan)) {
                                                    echo $salary_info->loan . " VND";
                                                } ?> </td>
                                            </tr>
                                            <tr>
                                                <td>Làm Việc (<?php echo $salary_info->total_days; ?> giờ)</td>
                                                <td class="text-right">
                                                    <?php
                                                        if($a > 0) { echo round($a,2).' VND'; }
                                                    ?>
                                                </td>
                                                <td class="text-right">
                                                    <?php
                                                        if($d > 0) { echo round($d,2).' VND'; }
                                                    ?>        
                                                </td>
                                                <td class="text-right"> </td>
                                            </tr>
                                            <!--<tr>
                                                ...
                                                <td class="text-right"> <?php
                                                        ...
                                                        echo $salary_info->diduction .'VND';
                                                    ?> </td>
                                        ...
                                        <tfoot class="tfoot-light">
                                            <tr>
                                                <th>Tổng</th>
                                                <th class="text-right"><?php $total_add = $salary_info->basic + $salary_info->medical + $salary_info->house_rent + $salary_info->bonus+$a; echo round($total_add,2); ?> VND</th>
                                                <th class="text-right"><?php $total_did = $salary_info->loan+$salary_info->diduction; echo round($total_did,2); ?> VND</th>
                                            </tr>
                                            <tr>
                                                <th></th>
                                                <th class="text-right">Tiền mạng</th>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content ">
                            ...
                            <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label">Thưởng Thêm</label>
