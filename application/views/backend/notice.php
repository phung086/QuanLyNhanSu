      ...
      <div class="page-wrapper">
        ...
        <div class="container-fluid">
                <div class="row m-b-10"> 
                    <div class="col-12">
                        <button type="button" class="btn btn-info"><i class="fa fa-plus"></i><a data-toggle="modal" data-target="#noticemodel" data-whatever="@getbootstrap" class="text-white "><i class="" aria-hidden="true"></i> Thêm </a></button>
                    </div>
                </div> 
                <div class="row">
                    <div class="col-12">
                                ...
                                <div class="modal-content ">
                                    ...
                                    <div class="modal-body">
                                            <div class="form-group">
                                                <label for="message-text" class="control-label">Tên</label>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label for="recipient-name1" class="control-label">Tệp</label>
