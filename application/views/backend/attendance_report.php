                            ...
                            <div class="card-body">
                                ...
                                <form method="post" action="Get_attendance_data_for_report" class="form-material row">
                                    <div class="form-group col-md-3">
                                        <input type="text" name="date_from" id="date_from" class="form-control mydatetimepickerFull" placeholder="Từ">
                                    </div>
                                    <div class="form-group col-md-3">
                                        <input type="text" name="date_to" id="date_to" class="form-control mydatetimepickerFull" placeholder="Tới">
                                    </div>
                                    <div class="form-group col-md-3">
                                    ...
                                    <div class="col-md-3 form-group">
                                        <input type="submit" class="btn btn-success" value="Xác Nhận" name="submit" id="getAtdReport">
                                    </div>
                                </form>
                            </div>
                        </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body EmployeeInfo">
                                ...
                                Làm <span class="hours"></span> Trong Số <span class="days"></span> Ngày
                            </div>
                        </div>
                    </div>
                </div>
