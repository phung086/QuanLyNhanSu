                    ...
                    <div class="col-12">
                                           ...
                                           <div class="row">
                                            <div class="col-md-6">
                                             <div class="form-group">
                                                ...
                                                <select class="select2 form-control custom-select assetsstock" data-placeholder="Chọn một mục" tabindex="1" name="logid" style="width:100%" required>
                                             ...
                                             <div class="form-group">
                                                ...
                                                <select class="select2 form-control custom-select" data-placeholder="Chọn một mục" tabindex="1" name="proid" id="OnEmValue" style="width:100%" required>
                                                  <option value="">Chọn ở đây</option>
                                             ...
                                             <div class="form-group">
                                                <label class="control-label">Danh sách công việc</label>
                                                <select class="form-control custom-select taskclass" data-placeholder="Chọn một mục" tabindex="1" name="taskid" id="taskval" required>
                                                  <option value="">Chọn ở đây</option>
                                             ...
                                             <div class="form-group">
                                                ...
                                                <select class="select2 form-control custom-select" data-placeholder="Chọn một mục" tabindex="1" name="assignid" id="assignval" style="width: 100%" required>
                                                  <option value="">Chọn ở đây</option>
                                            ...
                                            <span>Trong kho:<div style="color:red" class="qty"> </div></span>                                        
                                            <div class="form-group">
                                                <label class="control-label">Số Lượng Chỉ Định</label>
                        ...
                        <div class="modal fade" id="supportmodelupdate" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel1">
                            <div class="modal-dialog modal-lg" role="document">
                                <div class="modal-content ">
                                    <div class="modal-header">
                                        <h4 class="modal-title" id="exampleModalLabel1">Cập nhật hậu cần </h4>
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                    </div>
                                    ...
                                    <div class="modal-body">
                                       ...
                                       <div class="col-md-6">
                                        <div class="form-group">
                                                <label class="control-label">Dự Án</label>
                                                <select class="form-control custom-select" data-placeholder="Chọn một mục" tabindex="1" name="proid" id="OnEmValue" required>
                                                  <option value="">Chọn ở đây</option>
                                                   <?php foreach($projects as $value): ?>
                                                    <option value="<?php echo $value->id; ?>"><?php echo $value->pro_name; ?></option>
                                                    <?php endforeach; ?>
                                             ...
                                             <div class="form-group">
                                                <label class="control-label">Danh sách hậu cần</label>
                                                <select class="form-control custom-select assetsstock" data-placeholder="Chọn một mục" tabindex="1" name="logid" required>
                                                  <option value="">Chọn ở đây</option>
                                                   <?php foreach($assets as $value): ?>
                                                    <option value="<?php echo $value->ass_id; ?>"><?php echo $value->ass_name; ?></option>
                                                    <?php endforeach; ?>
                                             ...
                                             <div class="form-group">
                                                <label class="control-label">Chỉ định người dùng</label>
                                                <select class="form-control custom-select" data-placeholder="Chọn một mục" tabindex="1" name="assignid" id="assignval" required>
                                                  <option value="">Chọn ở đây</option>
                                                  <?php foreach($employee as $value): ?>
                                                  <option value="<?php echo $value->em_id ?>"><?php echo $value->first_name.' '.$value->last_name; ?></option>
                                                    <?php endforeach; ?>
                                            ...
                                            <span>Trong kho:</span><div style="color:red" class="qty"> </div>                                        
                                            <div class="form-group">
                                                <label class="control-label">Chỉ định số lượng</label>
                                                <input type="text" name="assignqty" class="form-control" id="recipient-name1 qty" value="" min="0" max="">
                                            </div>                                        
                                            <div class="form-group">
                                                <label class="control-label">Số Lượng Hoàn</label>
