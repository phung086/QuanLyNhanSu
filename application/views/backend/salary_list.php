         ...
         <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor"><i class="fa fa-bars" aria-hidden="true"></i> Lương bổng</h3>
                </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                        <li class="breadcrumb-item active"><i class="fa fa-university" aria-hidden="true"></i> Lương bổng</li>
                    </ol>
                </div>
            </div>
                    ...
                    <div class="col-12">
                        ...
                        <div class="card card-outline-info">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white"><i class="fa fa-hourglass-start" aria-hidden="true"></i>Bảng lương                    
                                </h4>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table id="example123" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Giờ </th>
                                                <th>Khấu trừ</th>
                                                <th>Tổng số chi trả</th>
                                                <th>Pay Date</th>
                                                <th>Trạng Thái</th>
                                                <th class="jsgrid-align-center">Hành Động</th>
                                            </tr>
                                        </thead>
                                        <!-- <tfoot>
                                            <tr>
                                           ...
                                           <?php $i =0; foreach($salary_info as $individual_info): ?>
                                            <tr>
                                                ...
                                                <td class="jsgrid-align-center ">
                                                    <a href="<?php echo base_url(); ?>payroll/invoice?Id=<?php echo $individual_info->pay_id; ?>&em=<?php echo $individual_info->emp_id; ?>" title="Sửa" class="btn btn-sm btn-danger waves-effect waves-light"><i class="fa fa-print"></i></a>
                                                </td>
                                            </tr>
                                            <?php endforeach; ?>
                                        </tbody>
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content ">
                                    <div class="modal-header">
                                        <h4 class="modal-title" id="exampleModalLabel1">Bảng lương</h4>
        ...
        buttons: [
            {
                ...
                customize: function ( win ) {
                    ...
                    $(win.document.body).find( 'div' )
                        ...
                        .css( 'height', '100px' )
                        .prepend(
                            '<img src="<?php echo base_url()?>assets/images/fsi.png" style="position:absolute;background-size:30%; top:0; left:0;" />'
                        );
