      ...
      <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor"><i class="fa fa-money" aria-hidden="true"></i> Cho vay</h3>
                </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                        <li class="breadcrumb-item active">Cho vay</li>
                    </ol>
                </div>
            </div>
         <div class="container-fluid">
            <div class="row m-b-10"> 
                <div class="col-12">
                    ...
                    <button type="button" class="btn btn-primary"><i class="fa fa-bars"></i><a href="<?php echo base_url(); ?>Loan/installment" class="text-white"><i class="" aria-hidden="true"></i>  Khoản vay trả góp</a></button>
                </div>
            </div> 
            <div class="row">
                <div class="col-12">
                    <div class="card card-outline-info">
                        <div class="card-header">
                            <h4 class="m-b-0 text-white"> Danh sách cho vay                    
                            </h4>
                        </div>
                        <div class="card-body">
                ...
                <div class="modal-content ">
                    ...
                    <div class="modal-body">
                             <div class="form-group row">
                                ...
                                <select class="form-control custom-select col-md-8" data-placeholder="Chọn một mục" tabindex="1" name="emid" required>
...
<!--                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <select class="form-control custom-select col-md-8" data-placeholder="Chọn một mục" tabindex="1" name="status" value="" required>
                                    <option value="">Chọn ở đây</option>
                                    <option value="Granted">Xác Nhận</option>
