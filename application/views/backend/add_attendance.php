                        ...
                        <div class="card card-outline-info">
                            ...
                            <div class="card-body">
                                    ...
                                    <div class="modal-body">
                                                ...
                                                <select class="form-control custom-select" data-placeholder="Chọn một mục" tabindex="1" name="emid" required>
                                        ...
                                        <div class="form-group" >
                                           <label class="m-t-20">Thời Gian Đăng Kí</label>
                                            <input class="form-control" name="signin" id="single-input" value="<?php if(!empty($attval->signin_time)) { echo  $attval->signin_time;} ?>" placeholder="Bây Giờ" required>
                                        </div>
                                        <div class="form-group">
                                        <label class="m-t-20">Thời Gian Kết Thúc</label>
                                    ...
                                    <input type="hidden" name="id" value="<?php if(!empty($attval->id)){ echo  $attval->id;} ?>" class="form-control" id="recipient-name1">                                       
                                        ...
                                        <button type="submit" id="attendanceUpdate" class="btn btn-success">Xác Nhận</button>
                                    </div>
                                    </form>
                            </div>
                        </div>
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content ">
                                    ...
                                    <div class="modal-body">
                                            ...
                                            <div class="form-group">
                                                <label class="control-label">Tên Kì Nghỉ Lễ</label>
