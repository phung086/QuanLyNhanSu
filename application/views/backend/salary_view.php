      ...
      <div class="col-12">
        <div class="card card-outline-info">
          <div class="card-header">
            <h4 class="m-b-0 text-white"> Bảng Lương Hàng Tháng
            </h4>
          </div>
          <div class="card-body">
            <!--Savd vdgff gdfg dfg dfgdfg df  gd gdd gfd-->
                <div class="row">
                  ...
                  <div class="form-group col-md-4">
                    <select class="form-control custom-select" data-placeholder="Chọn một mục" tabindex="1" id="depid" name="depid" style="margin-top: 21px;" required>
                    ...
                    <div class="col-md-12">
                      <div class="form-group">
                        <div class='input-group date' id=''>
                          <input type='text' name="datetime" class="form-control mydatetimepicker" placeholder="Thời Gian"/>
                        </div>
                      </div>
                    </div>
                  </div> 
                    <div class="form-group col-md-3">
                    <button style="float:left;margin-top:23px" type="submit" id="BtnSubmit" class="btn btn-success">Xác Nhận</button>          
                     </div>
                                </form>
                            </div>
                        </div>
      ...
      <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content ">
          <div class="modal-header">
            <h4 class="modal-title" id="">Chế Độ Tiền Lương
            </h4>
          ...
          <form method="post" action="pay_salary_add_record" id="generatePayrollForm" enctype="multipart/form-data">
            <div class="modal-body">
              <div class="form-group row">
                ...
                <div class="col-md-9">
                <select class="form-control custom-select" data-placeholder="Chọn một mục" id="emid" tabindex="1" name="emid" id="OnEmValue" required>
              ...
              <div class="form-group row">
                ...
                <select class="form-control custom-select" data-placeholder="Chọn một mục" tabindex="1" name="month" id="salaryMonth" required>
                  <option value="#">Lựa Chọn
                  </option>
              ...
              <div class="form-group row">
                <label class="control-label text-left col-md-5">Giờ Làm Việc
                </label>
                <div class="col-md-7">
              ...
              <div class="form-group row">
                ...
                <span>Làm Không Lương:</span><span class="wpay"></span> <span>hrs</span>
                </div>
              </div>                                       
              ...
              <div class="form-group row">
                <label class="control-label text-left col-md-5">Ngày Thanh Toán
                </label>
                <div class="col-md-7">
              ...
              <div class="form-group row">
                <label class="control-label text-left col-md-5">Lương Thực Nhận
                </label>
                <div class="col-md-7">
              ...
              <!--<div class="form-group row">
                ...
                <div class="col-md-7">
                <select class="form-control custom-select" data-placeholder="Chọn một mục" tabindex="1" name="status" required>
              ...
              <!--<div class="form-group row" style="margin-top: 25px;">
                ...
                <div class="col-md-9">
                <select class="form-control custom-select" data-placeholder="Chọn một mục" tabindex="1" name="paid_type" required>
                  <option value="#">Select Here
                  </option>
                  ...
                  <option value="Bank">Bank
                                ...
                                <div class="form-group row" style="margin-top: 25px;">
                                    <label class="control-label text-left col-md-3">Hình Thức Thanh Toán</label><br>
                                    <div class="col-md-9">
                                    ...
                                    <label for="radio_4" style="margin-left: 130px">Chuyển Khoản</label>
                                    </div>
                                </div>                             
            </div>
