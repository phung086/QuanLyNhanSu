         ...
         <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row m-b-10"> 
                    <div class="col-12">
                        <button type="button" class="btn btn-info"><i class="fa fa-plus"></i><a href="<?php echo base_url(); ?>attendance/Save_Attendance" class="text-white"><i class="" aria-hidden="true"></i> Thêm  </a></button>
                        <button type="button" class="btn btn-primary"><i class="fa fa-plus"></i><a href="#" class="text-white" data-toggle="modal" data-target="#Bulkmodal"><i class="" aria-hidden="true"></i>  Thêm Hàng Loạt</a></button>
                                           ...
                                           <?php foreach($attendancelist as $value): ?>
                                            <tr>
                                                ...
                                                <?php if($value->signout_time == '00:00:00') { ?>
                                                    <a href="Save_Attendance?A=<?php echo $value->id; ?>" title="Sửa" class="btn btn-sm btn-danger waves-effect waves-light" data-value="Approve" >Đăng Xuất</a><br>                           
                                                <?php } ?>
                                                    <a href="Save_Attendance?A=<?php echo $value->id; ?>" title="Sửa" class="btn btn-sm btn-primary waves-effect waves-light" data-value="Approve" ><i class="fa fa-pencil-square-o"></i></a>
                                                </td>
                                            </tr>
                                            <?php endforeach; ?>
                                        </tbody>
                                        ...
                                        <div class="modal-content">
                                           <form method="post" action="import" enctype="multipart/form-data">
                                            ...
                                            <div class="modal-body">
                                                <h4>Nhập Chấm Công<span><img src="<?php echo base_url(); ?>assets/images/finger.jpg" height="100px" width="100px"></span>Upload only CSV file</h4>
