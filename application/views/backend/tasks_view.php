      ...
      <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor"><i class="fa fa-tasks" aria-hidden="true"></i> Nhiêm Vụ</h3>
                </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row m-b-10"> 
                    <div class="col-12">
                        ...
                        <button type="button" class="btn btn-primary"><i class="fa fa-bars"></i><a href="<?php echo base_url(); ?>Projects/All_Tasks" class="text-white"><i class="" aria-hidden="true"></i>  Tham Gia Thực</a></button>
                        <?php } ?>
                    </div>
                </div>
                <div class="row">
                                ...
                                <div class="modal-content ">
                                    ...
                                    <div class="modal-body">
                                            ...
                                            <div class="form-group row">
                                             ...
                                             <div class="form-group row">
                                                <label class="control-label col-md-3">Chỉ Định</label>
                                                ...
                                                <label class="control-label col-md-2">Cộng Tác</label>
                                            ...
                                            <div class="form-group row">
                                                <label class="control-label col-md-3">Bắt Đầu</label>
