        ...
        <div class="message"></div>
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor"><i class="fa fa-th-large"></i> Danh sách tài sản</h3>
                </div>
            ...
            <div class="container-fluid">
                <div class="row m-b-10"> 
                    <div class="col-12">
                        <button type="button" class="btn btn-info"><i class="fa fa-plus"></i><a data-toggle="modal" data-target="#assetsmodel" data-whatever="@getbootstrap" class="text-white"><i class="" aria-hidden="true"></i> Thêm tài sản </a></button>
                    ...
                    <div class="col-12">
                        <div class="card card-outline-info">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white"> Danh sách tài sản</h4>
                            </div>
...
<!--                                                <td><?php echo $value->ass_id ?></td>
                                                ...
                                                <td class="jsgrid-align-center ">
                                                    <a href="#" title="Sửa" class="btn btn-sm btn-primary waves-effect waves-light assets" data-id="<?php echo $value->ass_id ?>"><i class="fa fa-pencil-square-o"></i></a>
                            ...
                            <div class="modal-dialog modal-lg" role="document">
                                <div class="modal-content ">
                                    <div class="modal-header">
                                        <h4 class="modal-title" id="exampleModalLabel1">Thêm nội dung </h4>
                                    ...
                                    <div class="modal-body">
                                           <div class="row">
                                            ...
                                            <div class="form-group">
                                                <label class="control-label">Tên nội dung</label>
                                            ...
                                            <div class="form-group">
                                                <label class="control-label">Thương hiệu tài sản</label>
                                                <input type="text" name="brand" value="" class="form-control" id="recipient-name1">
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label">Phiên Bản tài sản</label>
                                                <input type="text" name="model" value="" class="form-control" id="recipient-name1">
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label">Mã số tài sản</label>
