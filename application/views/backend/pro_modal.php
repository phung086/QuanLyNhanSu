                            ...
                            <div class="modal-dialog modal-lg" role="document">
                                <div class="modal-content ">
                                    <div class="modal-header">
                                        <h4 class="modal-title" id="exampleModalLabel1">Chỉ định hỗ trợ hậu cần</h4>
                                    ...
                                    <div class="modal-body">
                                             <div class="form-group row">
                                                ...
                                                <select class="form-control custom-select col-md-8" data-placeholder="Chọn một mục" tabindex="1" name="proid">
                                                    <option value="<?php echo $details->id; ?>"><?php echo $details->pro_name; ?></option>                                 
                                                </select>
                                            </div>
                                            <div class="form-group row">
                                                <label class="control-label col-md-3">Hạn</label>
                                            ...
                                            <div class="form-group row">
                                                <label class="control-label col-md-3">Danh sách công việc</label>
                                                <select class="form-control custom-select taskclass col-md-3" data-placeholder="Chọn một mục" tabindex="1" name="taskid" id="taskval" required>
                                                ...
                                                <label class="control-label col-md-2">Giao cho</label>
                                                <select class="select2 form-control custom-select col-md-4" data-placeholder="Chọn một mục" style="width:25%" tabindex="1" name="teamhead">
                                            ...
                                            <div class="form-group row">
                                                <label for="message-text" class="control-label col-md-3">Nhận Xét</label>
                                                <textarea class="form-control col-md-8" name="remarks" id="message-text1" minlength="10" maxlength="1400" rows="4"></textarea>
                                            </div>                                                                 
                                            
                                             <div class="form-group row">
                                                <label class="control-label col-md-3">Hỗ trợ hậu cần</label>
                                                <select class="select2 form-control custom-select col-md-4 assetsstock" data-placeholder="Chọn một mục" style="width:35%" tabindex="1" name="logistic">
                                                  <option value="">Chọn ở đây</option>
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="submit" <?php if($this->session->userdata('user_type')=='EMPLOYEE'){ ?> disabled <?php } ?> class="btn btn-primary">Xác Nhận</button>
                                    </div>
                                    </form>
                                </div>
                            </div>
                            ...
                            <div class="modal-dialog modal-lg" role="document">
                                <div class="modal-content ">
                                    ...
                                    <div class="modal-body">
                                             <div class="form-group row">
                                                <label class="control-label col-md-3">Danh sách dự án</label>
                                                <select class="form-control custom-select col-md-8 proid" data-placeholder="Chọn một mục" tabindex="1" name="projectid">
                                                    <option value="<?php echo $details->id; ?>"><?php echo $details->pro_name; ?></option>
                                            ...
                                            <div class="form-group row">
                                             ...
                                             <div class="form-group row">
                                                ...
                                                <select class="select2 form-control custom-select col-md-3" data-placeholder="Chọn một mục" style="width:25%" tabindex="1" name="teamhead">
                                                  <option value="">Chọn ở đây</option>
                                                   <?php foreach($employee as $value): ?>
                                                    <option value="<?php echo $value->em_id; ?>"><?php echo $value->first_name.' '.$value->last_name; ?></option>
                                                    <?php endforeach; ?>
                                                </select>
                                                <label class="control-label col-md-2">Hỗ Trợ</label>
                                                <select class="select2 form-control select2-multiple col-md-3" data-placeholder="Chọn một mục" multiple="multiple" style="width:25%" tabindex="1" name="assignto[]">
                                                  <option value="">Chọn ở đây</option>
                                                   <?php foreach($employee as $value): ?>
                                                    <option value="<?php echo $value->em_id; ?>"><?php echo $value->first_name.' '.$value->last_name; ?></option>
                                                    <?php endforeach; ?>
                                            ...
                                            <div class="form-group row">
                                              ...
                                              <div class="form-group row">
                                               <label class="control-label col-md-3">Trạng Thái: </label>
                                                ...
                                                <label for="radio_2">Đang Chạy</label>
                        ...
                        <div class="modal fade" id="fieldmodel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel1">
                            <div class="modal-dialog modal-lg" role="document">
                                <div class="modal-content ">
                                    <div class="modal-header">
                                        <h4 class="modal-title" id="exampleModalLabel1">Nhiệm Vụ Thực Tế</h4>
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                    </div>
                                    ...
                                    <div class="modal-body">
                                             <div class="form-group row">
                                                <label class="control-label col-md-3">Danh sách dự án</label>
                                                <select class="form-control custom-select col-md-6 proid" data-placeholder="Chọn một mục" tabindex="1" name="projectid">
                                                    <option value="<?php echo $details->id; ?>"><?php echo $details->pro_name; ?></option>
                                                </select>
                                            </div>
                                            <div class="form-group row">
                                            ...
                                            <div class="form-group row">
                                                <label class="control-label col-md-3">Ngày Bắt Đầu</label>
                                                <input type="text" name="startdate" class="form-control col-md-3 mydatepicker" id="recipient-name1">
                                                <label class="control-label col-md-1">Ngày Kết Thúc</label>
                                                <input type="text" name="enddate" class="form-control col-md-3 mydatepicker" id="recipient-name1">                                                
                                            </div>
                                            <div class="form-group row">
