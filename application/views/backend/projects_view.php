            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12 col-xlg-12 col-md-12">
                        <div class="card">
                            ...
                            <ul class="nav nav-tabs profile-tab" role="tablist">
                                ...
                                <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#education" role="tab"> Dữ Liệu Dự án</a> </li>
                                ...
                                <br/>
                                    ...
                                    <div class="modal-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control custom-select" data-placeholder="Chọn một mục" tabindex="1" name="prostatus" <?php if($this->session->userdata('user_type')=='EMPLOYEE'){ ?> readonly <?php } ?> required>
                                    ...
                                    <div class="modal-footer">
                                       <input type="hidden" name="proid" value="<?php echo $details->id; ?>">
                                        ...
                                        <button type="submit" <?php if($this->session->userdata('user_type')=='EMPLOYEE'){ ?> disabled <?php } ?> class="btn btn-success">Xác Nhận</button>
                                    </div>
                                    </form>
				                        </div>
                                    </div>                                           
                    ...
                    <div class="table-responsive " id="">
                        ...
                        <a data-toggle="modal" data-target="#tasksmodel" data-whatever="@getbootstrap" class="text-white btn btn-info"> Thêm Công Việc</a></span> <?php } ?>                    
                    <div class="table-responsive " id="">
                        <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                            <thead>
                                <tr>
                               ...
                               <?php foreach($tasklist as $value): ?>
                                <tr>
                                    ...
                                    <td class="jsgrid-align-center ">
                                        <a href="#" title="Sửa" class="btn btn-sm btn-primary waves-effect waves-light taskmodal" data-id="<?php echo $value->id ?>"><i class="fa fa-pencil-square-o"></i></a>
                                        <a onclick="alert('Bạn có chắc chắn muốn xoá?')" href="#" title="Xoá" class="btn btn-sm btn-info waves-effect waves-light TasksDelet" data-id="<?php echo $value->id ?>"><i class="fa fa-trash-o"></i></a>
                                    </td>
                                    <?php } ?>
                                </tr>
                                <?php endforeach; ?>
                                ...
                                <div class="tab-pane" id="field" role="tabpanel">
                                    <div class="card">
				                        <div class="card-body">
			                        		<h3 class="card-title">Nhiệm vụ thực tế</h3>
                        <span class="pull-right">
                        <?php if($this->session->userdata('user_type')!='EMPLOYEE'){ ?>  
                        <a data-toggle="modal" data-target="#fieldmodel" data-whatever="@getbootstrap" class="text-white btn btn-info"> Thêm</a></span> <?php } ?>                    
                    <div class="table-responsive " id="">
                        <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                            <thead>
                                <tr>
...
<!--                                       <td class="jsgrid-align-center ">  
                                    ...
                                    <td class="jsgrid-align-center ">
                                        <a href="#" title="Sửa" class="btn btn-sm btn-primary waves-effect waves-light taskmodal" data-id="<?php echo $value->id ?>"><i class="fa fa-pencil-square-o"></i></a>
                                        <a onclick="alert('Bạn có chắc chắn muốn xoá ?')" href="#" title="Delete" class="btn btn-sm btn-info waves-effect waves-light TasksDelet" data-id="<?php echo $value->id ?>"><i class="fa fa-trash-o"></i></a>
                                    </td>
                                    <?php } ?>
                                </tr>
                                <?php endforeach; ?>
                            ...
                            <tbody>
                               <?php foreach($files as $value): ?>
                                <tr>
                                    ...
                                    <td class="jsgrid-align-center ">
                                       <?php if($this->session->userdata('user_type')!='EMPLOYEE'){ ?>
                                        <a href="#" title="Xoá" class="btn btn-sm btn-info waves-effect waves-light filedelet" data-id="<?php echo $value->id ?>"><i class="fa fa-trash-o"></i></a>
                                        <?php } ?>
                                    </td>
                                </tr>
                                <?php endforeach; ?>
                                        ...
                                        <?php if($this->session->userdata('user_type')!='EMPLOYEE'){ ?>                  
			                                <form class="row" id="insert_education" action="Add_File" method="post" enctype="multipart/form-data">
                                                ...
                                                <select class="form-control custom-select" data-placeholder="Chọn một mục" tabindex="1" name="assignto" required>
                                                <?php
                                                $id = $details->id;
                                                    echo $id;
                            ...
                            <tbody>
                               <?php foreach($notes as $value): ?>
                                <tr>
                                    ...
                                    <td class="jsgrid-align-center ">
                                        <a href="#" title="Sửa" class="btn btn-sm btn-primary waves-effect waves-light notes" data-id="<?php echo $value->id ?>"><i class="fa fa-pencil-square-o"></i></a>
                                        <?php if($this->session->userdata('user_type')!='EMPLOYEE'){ ?>
                                        <a href="#" title="Xoá" class="btn btn-sm btn-danger waves-effect waves-light notesdelet" data-id="<?php echo $value->id ?>"><i class="fa fa-trash-o"></i></a>
                                        <?php } ?>
                                    </td>
                                </tr>
                                <?php endforeach; ?>
			                                ...
			                                <form class="row" action="Add_Pro_Notes" method="post" enctype="multipart/form-data" id="notesform">
			                                    ...
			                                    <div class="form-group col-md-6 m-t-5">
			                                        <label>Giao cho</label>
                                                <select class="form-control custom-select" data-placeholder="Chọn một mục" tabindex="1" name="assignto">
                                                <?php
                                                //$id = $details->id;
                                                    //echo $id;
                                                $assignvalue = $this->project_model->getProjectAssignUser($id);  
                            ...
                            <tbody>
                               <?php foreach($expenses as $value): ?>
                                <tr>
                                    ...
                                    <td class="jsgrid-align-center ">
                                       <?php if($this->session->userdata('user_type')!='EMPLOYEE'){ ?>
                                        <a href="#" title="Sửa" class="btn btn-sm btn-primary waves-effect waves-light expenses" data-id="<?php echo $value->id ?>"><i class="fa fa-pencil-square-o"></i></a>
                                        <a href="#" onclick="confirm('Bạn có chắc chắn muốn xoá ?')" title="Delete" class="btn btn-sm btn-danger waves-effect waves-light exdelet" data-id="<?php echo $value->id ?>"><i class="fa fa-trash-o"></i></a>
                                        <?php } ?>
                                    </td>
                                </tr>
                                <?php endforeach; ?>
                            ...
                            <tbody>
                               <?php foreach($expenses as $value): ?>
                                <tr>
                                    ...
                                    <td><?php echo $value->amount ?></td>
                                    <td class="jsgrid-align-center ">
                                        <a href="edit-employee.php" title="Sửa" class="btn btn-sm btn-primary waves-effect waves-light"><i class="fa fa-pencil-square-o"></i></a>
                                ...
                                <?php endforeach; ?>
                                        ...
                                        <form class="row">
                                            <div class="form-group col-md-6 m-t-5">
                                                <label class="">CV Nhân Viên</label>
                                                <input type="file" name="file" class="form-control" required="" aria-invalid="false">
                                            </div>
                                            <div class="form-group col-md-6 m-t-5">
                                                <label class="">Giấy Tờ Tuỳ Thân</label>
                                                <input type="file" name="file" class="form-control" required="" aria-invalid="false">
                                            </div>
                                            <div class="form-group">
                                                <div class="col-sm-12">
                                                    <button class="btn btn-success">Tải Tệp Lên</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
                            ...
                            <tbody>
                               <?php foreach($logisticlist as $value): ?>
                                <tr>
                                    ...
                                    <td><?php echo $value->end_date ?></td>
                                    <td class="jsgrid-align-center ">
                                        <a href="#" title="Sửa" class="btn btn-sm btn-primary waves-effect waves-light logisticeid" id="logisticeid" data-id="<?php echo $value->ass_id ?>"><i class="fa fa-pencil-square-o"></i></a>
